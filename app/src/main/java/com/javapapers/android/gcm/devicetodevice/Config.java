...
public interface Config {
	...
	static final String APP_SERVER_URL = "http://172.30.5.82:8080/GCM-Server-Device-To-Device/GCMNotification?";

	// Google Project Number
	static final String GOOGLE_PROJECT_ID = "588800084950";
